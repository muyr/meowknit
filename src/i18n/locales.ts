...
export const uiCopy = {
  'zh-CN': {
    ...
    usageCategoryTitle: '用途',
    usageCategoryNavLabel: '按用途筛选作品',
    craftCategoryTitle: '工艺',
    craftCategoryNavLabel: '按工艺筛选作品',
    allWorks: '全部作品',
  ...
  en: {
    ...
    usageCategoryNavLabel: 'Filter works by usage',
    craftCategoryTitle: 'Craft',
    craftCategoryNavLabel: 'Filter works by craft',
    allWorks: 'All works',
